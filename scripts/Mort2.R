...
mort14<- left_join(x = mort13,y = mort2,by=c("Boar Stud"="Boar Stud"))
...
mort25<- left_join(x = mort24,y = mort1,by=c("Boar Stud"="Boar Stud"))

# mort25[is.na(mort25)]<-0

mort26<-mort25 %>% 
  group_by(`Boar Stud`) %>% 
  summarize('Average Inventory'=mean(c(n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12,n13), na.rm = TRUE))
